...
These are working notes exploring the philosophy behind AI workflow rules. The published article [What Makes Good AI Rules Files](/writing/ai-as-your-partner/what-makes-good-ai-rules-files/) covers the mechanics: where files go, what sections to include. This explores the *why*.
...
**[[Research-Human-Partnership-Patterns]]** (Claude) — Cross-domain research on what makes human partnerships work: marriage, business co-founders, creative collaborations, high-stakes teams, mentorship, cross-cultural partnerships. Six foundational patterns emerge, with direct implications for human-AI collaboration.
