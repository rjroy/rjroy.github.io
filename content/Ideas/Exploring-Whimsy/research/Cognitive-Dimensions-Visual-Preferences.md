...
| Trait | Color Preference Pattern |
|-------|-------------------------|
| Extraversion | High-chroma/saturated colors; warmer color temperatures |
| Introversion | Low-chroma/muted colors; cooler color temperatures |
| High neuroticism | Prefer calming blues, greens, lavender; avoid intense reds and neons |
| High openness | More varied and unconventional color palette acceptance |
| High conscientiousness | Light blue preference; organized, predictable color schemes |
...
- Amaro, L. et al. (2023). "An Overstimulated Consumer in a Highly Visual World: The HSP Trait." *Sensitivity Research*. https://sensitivityresearch.com/an-overstimulated-consumer-in-a-highly-visual-world-the-hsp-trait/

- Augustin, S. & Weidemann, S. (2016). Workplace design and personality types. *WORKTECH Academy*. https://www.worktechacademy.com/can-we-tailor-workplace-design-more-closely-to-personality-types/

- Chamorro-Premuzic, T. et al. (2009). "The influence of personality traits, previous experience of art, and demographic variables on artistic preference." *Personality and Individual Differences*. https://www.sciencedirect.com/science/article/abs/pii/S0191886900002026

- Eysenck, H.J. Personality dimensions and arousal theory. *Psychology Town*. https://psychology.town/personality-theories/eysencks-personality-dimensions-hierarchical-model/

- Eysenck's Theory of Personality and the Role of Background Music in Cognitive Task Performance. *PMC/NIH*. https://pmc.ncbi.nlm.nih.gov/articles/PMC5694457/

- Feist, G.J. & Brady, T.R. (2004). "Openness to Experience, Non-Conformity, and the Preference for Abstract Art." *Empirical Studies of the Arts*. https://www.academia.edu/92072687/Openness_to_Experience_Non_Conformity_and_the_Preference_for_Abstract_Art / https://www.semanticscholar.org/paper/Openness-to-Experience,-Non-Conformity,-and-the-for-Feist-Brady/fc61b30350db5774ca5273220322f0c2bd87459d

- Gridley, M.C. (2006, 2013). "Preference for abstract art according to thinking styles & personality." *ResearchGate*. https://www.researchgate.net/publication/286049841_Preference_for_abstract_art_according_to_thinking_styles_personality

- Jonauskaite, D. et al. (2021). Color-personality associations.

- Pazda, A.D. & Thorstenson, C.A. (2018). "Extraversion predicts a preference for high-chroma colors." *Personality and Individual Differences*. https://www.sciencedirect.com/science/article/abs/pii/S019188691830028X

- Spehar, B. et al. (2016). "A Complex Story: Universal Preference vs. Individual Differences Shaping Aesthetic Response to Fractals Patterns." *Frontiers in Human Neuroscience / PMC*. https://pmc.ncbi.nlm.nih.gov/articles/PMC4877522/

- (2025). "Exploring the association between personality traits and colour saturation preference using machine learning." *Acta Psychologica*. https://www.sciencedirect.com/science/article/pii/S0001691825000654

- Furnham, A. & Bunyan, M. (1988); Furnham, A. & Avison, M. (1997). Sensation seeking and art preferences.

- Jagiellowicz, J. et al. (2011). HSP neuroimaging studies.

- Kaplan, R. & Kaplan, S. Attention Restoration Theory.

- Liang, B. & Kale, S.H. (2012). Cultural variation in abstract/concrete thinking.

- Martin, B.A.S., Sherrard, M.J. & Wentzel, D. (2005). Need for Cognition and visual complexity preferences.

- Tobacyck, J. et al. (1981). Sensation seeking and art preferences.

- Trope, Y. & Liberman, N. (2010). Construal Level Theory.

- Woods, R.E. & Knuth, K.H. (2023). Biophilia Reactivity Hypothesis.

- Zuckerman, M. (1994). Sensation seeking and design complexity preferences.
